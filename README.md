...
Code and data for reproducing the numerical experiments in the paper **“A Perturbation Method for Index Detection for Linear Matrix Pencils”**  by Hanna Blazhko and Michał Wojtylak.
